...
import { dashboardBackground, orderPlacedImg, successLogo } from '../../assets';
                ...
                <div className="row mt-4">
                    <div className="col-lg-3 col-md-12 px-1">
                        <div className='bg-white p-3'
                            ...
                            <div>
                                <img src={orderPlacedImg} alt="Review Order" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white panel-shadow px-5 py-4 mt-md-1" style={{
                            ...
                            <div>
                                ...
                                <div className="text-center">
                                    ...
                                    <p style={{ fontSize: '20px', color: '#9F9F9F', }}>You will be notified shortly when to make payment.</p>
                                    <Button
                                        variant="contained"
                                        className='py-2 mt-4'
